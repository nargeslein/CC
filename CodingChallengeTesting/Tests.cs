    ...
    public class Tests
    {
        ...
        public IEnumerable<TestCaseData> GetCases
        {
            get
            {
                ...
                yield return new TestCaseData(_t3, _rates, "Stock Portfolio", 5800m, GBP);
        ...
        public void TestConsolidationPortfolio()
        {
            ...
            Assert.AreEqual(portfolio.Assets.Count, 5);
        ...
        //[Test("Test to ensure that duplicate assets cannot be added")]
        [Test]
        public void TestAddAssetsStock()
        {
            Assert.DoesNotThrow(delegate
            {
                var portfolio = new AssetPortfolio(_flatrates, "Duplicate Asset Portfolio");
        ...
        [Test]
        public void TestConsolidationException()
        {
            ConsolidationException ex = Assert.Throws<ConsolidationException>(delegate
            {
                ...
                asset.Consolidate(_t4); 
            });            
        }

        [Test]
        public void TestConsolidationNoException()
        {
            Assert.DoesNotThrow(delegate
            {
                _t4 = new List<Asset>
                ...
                Asset newAsset =  asset.Consolidate(_t4);
